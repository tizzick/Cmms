...
/// <summary>
/// Configures the MVC options to add additional conventions.
/// </summary>
public class ConfigureMvcOptions(CacheProfileOptions cacheProfileOptions) : IConfigureOptions<MvcOptions>
{
    private readonly CacheProfileOptions cacheProfileOptions = cacheProfileOptions;
