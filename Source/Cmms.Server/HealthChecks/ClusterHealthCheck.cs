...
/// </summary>
public class ClusterHealthCheck(IClusterClient client, ILogger<ClusterHealthCheck> logger) : IHealthCheck
{
    ...
    private readonly ILogger<ClusterHealthCheck> logger = logger;
