...
/// storage provider.
/// </summary>
public class StorageHealthCheck(IClusterClient client, ILogger<StorageHealthCheck> logger) : IHealthCheck
{
    private const string FailedMessage = "Failed storage health check.";
    private readonly IClusterClient client = client;
    private readonly ILogger<StorageHealthCheck> logger = logger;
