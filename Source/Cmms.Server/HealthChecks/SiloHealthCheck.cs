...
/// are healthy.
/// </summary>
public class SiloHealthCheck(IEnumerable<IHealthCheckParticipant> participants) : IHealthCheck
{
    private static long lastCheckTime = DateTime.UtcNow.ToBinary();
    private readonly IEnumerable<IHealthCheckParticipant> participants = participants;
